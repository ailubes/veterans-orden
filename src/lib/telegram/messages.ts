...
export const msg = {
  ...
  regComplete: (firstName: string) =>
    ...
    `Ваш акаунт в Ордені Ветеранів створено. Членство розвивається через мережу: ` +
    `запросіть 1 друга за вашим реферальним посиланням — і ви автоматично перейдете ` +
    `на рівень «Кандидат в члени» з правом голосу на праймеріз.\n\n` +
