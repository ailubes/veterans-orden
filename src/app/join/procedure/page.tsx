  ...
  return (
    <PageLayout>
      ...
      <PageContent narrow>
        ...
        <p>
          <strong>Окремо про осередки (Командерії):</strong> подати створення осередку через кабінет може лише роль
          {' '}
          <strong>«Почесний Член»</strong>. У формі вказуються назва осередку, код, тип, KATOTTG-код населеного пункту
          та адреса.
        </p>
      </PageContent>
