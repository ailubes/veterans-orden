  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        <div>
          <p className="label text-bronze mb-2">СПОВІЩЕННЯ</p>
        ...
        {unreadCount > 0 && (
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-bronze hover:bg-bronze/10 rounded-lg transition-colors"
          >
      ...
      <div className="flex flex-wrap gap-3 mb-6">
        ...
        <div className="flex bg-timber-dark/5 rounded-lg p-1">
          ...
          >
            Непрочитані
            {unreadCount > 0 && (
              <span className="ml-1.5 px-1.5 py-0.5 text-xs bg-bronze text-white rounded-full">
                {unreadCount}
              </span>
            )}
          </button>
        ...
        <div className="relative">
          <select
            ...
            className="appearance-none pl-3 pr-8 py-2 text-sm border border-line rounded-lg/20 rounded-lg bg-panel-900 focus:border-bronze focus:outline-none cursor-pointer"
          >
          ...
          <Filter className="absolute right-2.5 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-500 pointer-events-none" />
        </div>
      </div>
      ...
      {isLoading && filteredNotifications.length === 0 ? (
        ...
        <div className="bg-panel-900 border border-line rounded-lg p-12 relative text-center">
          ...
          <BellOff className="w-12 h-12 mx-auto mb-4 text-muted-500/40" />
