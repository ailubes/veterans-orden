...
import { Scale, Phone, Globe, MapPin, ChevronLeft, CheckCircle, XCircle } from 'lucide-react';
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="mb-6">
        ...
        <p className="mono text-bronze text-xs tracking-widest mb-2">// ПРАВОВА ДОПОМОГА</p>
        <div className="flex items-center gap-3 mb-3">
          <div className="w-10 h-10 rounded-lg bg-purple-500/10 border border-purple-500/30 flex items-center justify-center">
            <Scale size={20} className="text-purple-400" />
          </div>
          <h1 className="font-syne text-3xl font-bold text-text-100">Правова допомога</h1>
        </div>
        <p className="text-muted-500 text-sm">
          Безоплатні юридичні консультації, захист прав ветеранів, пільги та соціальний захист.
        </p>
      </div>
...
function ResourceCard({ resource }: { resource: Resource }) {
  ...
  return (
    <div className="bg-panel-900 border border-line rounded-lg p-5 hover:border-purple-500/30 transition-colors">
