    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        <div>
          ...
          <h1 className="font-syne text-2xl sm:text-3xl font-bold">Голосування</h1>
        </div>
        <Link href="/admin/votes/new" className="btn flex items-center justify-center gap-2 w-full sm:w-auto">
          <Plus size={18} />
