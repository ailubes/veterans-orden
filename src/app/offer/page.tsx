      ...
      <PageContent narrow>
        <div className="space-y-10 text-sm leading-relaxed">
          ...
          <section>
            ...
            <p className="mb-3">
              3.2. Оплата здійснюється у гривнях (UAH) через платіжну систему{' '}
              <a href="https://hutko.org" className="text-bronze hover:underline">
                HUTKO
              </a>{' '}
              з використанням банківської картки, Google Pay або Apple Pay.
            </p>
            <p className="mb-3">
              3.3. При виборі місячного членства Член самостійно здійснює оплату
              щомісяця. При виборі річного членства — одноразово за 12 місяців
              наперед.
            </p>
            <p>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-1 ml-4">
              ...
              <li>відмовитись від членства у будь-який час;</li>
          ...
          <section>
            ...
            <p className="mb-3">
              5.3. Для припинення членства необхідно звернутись на адресу{' '}
              <a href="mailto:info@ordenv.org" className="text-bronze hover:underline">
                info@ordenv.org
              </a>{' '}
              у будь-який момент. Членство зберігається до кінця оплаченого
              періоду.
            </p>
            <p>
          ...
          <section>
            ...
            <p className="mb-3">
              ...
              обробляються безпосередньо платіжною системою HUTKO відповідно до
              стандарту PCI DSS.
            </p>
            <p>
          ...
          <section>
            ...
            <p className="mb-3">
              8.2. Договір продовжується на наступний оплачений період після
              здійснення Членом наступного платежу.
            </p>
            <p>
