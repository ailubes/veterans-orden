  ...
  const navLinks: NavItem[] = [
    ...
    },
    {
      ...
      children: [
        ...
        { href: '/directions/legal-protection', label: 'Правовий захист' },
        { href: '/directions/psychological-support', label: 'Психологічна підтримка' },
        { href: '/directions/education', label: 'Освіта' },
        { href: '/directions/civic-campaigns', label: 'Громадянські кампанії' },
        { href: '/directions/mutual-aid', label: 'Взаємодопомога' },
