...
const frameworks = [
  {
    num: '01',
    title: 'ГУРТУВАННЯ',
    desc: "Об'єднуємо 1,000,000 громадян в Орден для формування колективної спроможності.",
  },
  {
    num: '02',
    title: 'ВИМОГИ',
    desc: 'Формуємо програмні вимоги до політиків шляхом прямого голосування кожного члена Ордену.',
  },
  {
    num: '03',
    title: 'КОНТРОЛЬ',
    ...
    >
      {frameworks.map((item, i) => (
        <div key={item.num} className="card">
          {i === 0 && <div className="joint joint-tl" />}
          {i === 2 && <div className="joint joint-tr" />}
