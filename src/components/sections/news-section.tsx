...
const sampleNews: NewsItem[] = [
  {
    date: '18.12.2024',
    title: 'Орден проголосував за Положення про праймеріз',
    excerpt:
      'Члени Ордену одноголосно підтримали новий механізм внутрішнього відбору кандидатів.',
    slug: 'praymeriz-2024',
  },
  {
    date: '15.12.2024',
  ...
  {
    date: '10.12.2024',
    title: 'Що зміниться в Ордені до кінця 2025 року?',
    excerpt:
